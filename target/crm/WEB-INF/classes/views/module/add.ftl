        ...
        <div class="layui-input-block">
            <#if grade??>
                <select name="grade" readonly="readonly">
                   <option value="0"  <#if grade==0>  selected="selected">一级菜单</option></#if>
                   <option value="1" <#if grade==1>  selected="selected">二级菜单</option></#if>
                   <option value="2"  <#if grade==2> selected="selected">三级菜单</option></#if>
                </select>
            </#if>
        </div>
    </div>
